...
\begin{table}[H]
  ...
  \texttt{\textbf{Depot}(\underline{ID}, Name, Address, City, Province, Number\_Of\_Employees, Region)} \\ \hline
  \texttt{\textbf{Municipality}(\underline{ID}, Name, Depot\_ID)} \\ \hline
  \end{tabularx}
